##############################################################################
# Section: LOCAL logging
CACHE_DISABLE_SYSLOG 1
CACHE_REDIRECT_DEBUG_FILENAME /tmp/solcache.log
...
SESSION_USERNAME {{ sol_cache_clientusr_name }}
SESSION_PASSWORD {{ sol_cache_clientusr_pwd }}
...
SESSION_HOST {{ sol_broker_primary_private_ip }},{{ sol_broker_backup_private_ip }}
...
SESSION_VPN_NAME {{ sol_cache_vpn_name }}
...
SESSION_CLIENT_NAME cache_client_{{ sol_cache_instance_name }}
...
SESSION_APPLICATION_DESCRIPTION Solace PubSub+ Cache {{ sol_cache_instance_name }}
...
CACHE_INSTANCE_NAME {{ sol_cache_instance_name }}
